...
<div class="page_container">
	...
	if((int)$_POST['def_1_ball']== "on"){$def_1_ball=1;}
	if((int)$_POST['def_2_ball']== "on"){$def_2_ball=1;}
	if((int)$_POST['def_3_ball']== "on"){$def_3_ball=1;}
	if((int)$_POST['def_4_ball']== "on"){$def_4_ball=1;}
	if((int)$_POST['def_5_ball']== "on"){$def_5_ball=1;}
	//Shooting variables
