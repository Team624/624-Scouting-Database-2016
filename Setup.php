...
$eventcode="2015";
//I intend to add a button to load team and match schedule and use a bunch of conditional statements to select the url through an html input
...
<div class="page_container">
	...
	<br><br>Update:Can now load and update the teams list and match schedule from all the regionals we are going to.
