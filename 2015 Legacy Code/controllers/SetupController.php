...
class SetupController extends Controller {
  ...
  public function loadTeams() {
    ...
    $html = @file_get_contents("http://www.thebluealliance.com/api/v2/event/2015$eventCode/teams", false, $context);
    if ($html === false) {
  ...
  public function loadSchedule() {
    ...
    $html = @file_get_contents("http://www2.usfirst.org/2015comp/Events/$eventCode/schedulequal.html");
    if ($html === false) {
